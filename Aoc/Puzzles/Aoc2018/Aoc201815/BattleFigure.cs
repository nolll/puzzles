...
public class BattleFigure(char type, int attackPower, Coord address)
{
    public int HitPoints { get; private set; } = 200;
    public char Type { get; } = type;
    public int AttackPower { get; } = attackPower;
    public Coord Address { get; private set; } = address;
    public bool IsDead => HitPoints <= 0;

    public void Hit(int attackPower) => HitPoints -= attackPower;
    public void MoveTo(Coord address) => Address = address;
}