...
namespace ConsoleApp.Years.Year2016.Puzzles
{
    public class Day06 : Day2016
    {
        ...
        protected override void RunDay()
        {
            ...
            var messageMostCommon = reader.ReadMostCommon(LegacyInput);
            Console.WriteLine($"Message most common: {messageMostCommon}");

            WritePartTitle();
            var messageLeastCommon = reader.ReadLeastCommon(LegacyInput);
            Console.WriteLine($"Message least common: {messageLeastCommon}");
        }

        protected override string LegacyInput => @"iyeajeby
qengiuoe
wxzardgo
jciguemn
zcampkps
