...
namespace ConsoleApp.Years.Year2016.Puzzles
{
    public class Day07 : Day2016
    {
        ...
        protected override void RunDay()
        {
            ...
            var tlsSupportCount = tester.TlsSupportCount(LegacyInput);
            Console.WriteLine($"Valid tls ip addresses: {tlsSupportCount}");

            WritePartTitle();
            var sslSupportCount = tester.SslSupportCount(LegacyInput);
            Console.WriteLine($"Valid ssl ip addresses: {sslSupportCount}");
        }

        protected override string LegacyInput => @"dnwtsgywerfamfv[gwrhdujbiowtcirq]bjbhmuxdcasenlctwgh
