...
namespace ConsoleApp.Years.Year2017.Puzzles
{
    public class Day04 : Day2017
    {
        ...
        protected override void RunDay()
        {
            ...
            var validCount1 = validator.GetValidCount1(LegacyInput);
            Console.WriteLine($"Valid passphrases 1: {validCount1}");

            WritePartTitle();
            var validCount2 = validator.GetValidCount2(LegacyInput);
            Console.WriteLine($"Valid passphrases 2: {validCount2}");
        }

        protected override string LegacyInput => @"una bokpr ftz ryw nau yknf fguaczl anu
