...
namespace ConsoleApp.Years.Year2018.Puzzles
{
    public class Day01 : Day2018
    {
        ...
        {
            WritePartTitle();
            var frequencyPuzzle = new FrequencyPuzzle(LegacyInput);
            var resultingFrequency = frequencyPuzzle.ResultingFrequency;
            Console.WriteLine($"Resulting frequency: {resultingFrequency}");

            WritePartTitle();
            var frequencyRepeatPuzzle = new FrequencyRepeatPuzzle(LegacyInput);
        ...
        protected override string LegacyInput => @"-9
+7
+5
-13
+6
