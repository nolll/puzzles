...
namespace ConsoleApp.Years.Year2018.Puzzles
{
    public class Day02 : Day2018
    {
        ...
        {
            WritePartTitle();
            var boxChecksumPuzzle = new BoxChecksumPuzzle(LegacyInput);
            Console.WriteLine($"Hash: {boxChecksumPuzzle.Checksum}");

            WritePartTitle();
            var similarIdsPuzzle = new SimilarIdsPuzzle(LegacyInput);
            Console.WriteLine($"Common letters: {similarIdsPuzzle.CommonLetters}");
        }

        protected override string LegacyInput => @"ayitmcjvlhedbsyoqfzukjpxwt
