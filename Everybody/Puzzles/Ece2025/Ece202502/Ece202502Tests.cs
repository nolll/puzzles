...
public class Ece202502Tests
{
    ...
    public void ShouldBeEngraved(long x, long y) => Sut.ShouldBeEngraved(x, y).Should().BeTrue();
    ...
    public void ShouldNotBeEngraved(long x, long y) => Sut.ShouldBeEngraved(x, y).Should().BeFalse();
