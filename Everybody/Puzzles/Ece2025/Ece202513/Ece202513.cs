...
public class Ece202513 : EverybodyEventPuzzle
{
    ...
    public int Part1(string input) => Solve(input, 2025);
    
    [Puzzle("120dc70bb2265cf1dd44b351a776f4eb")]
    public int Part2(string input) => Solve(input, 20252025);
    
    [Puzzle("ad5947829c2a32c895e2406a54daa389")]
    public int Part3(string input) => Solve(input, 202520252025);
