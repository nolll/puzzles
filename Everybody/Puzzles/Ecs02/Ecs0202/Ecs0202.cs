...
public class Ecs0202 : EverybodyStoryPuzzle
{
    ...
    [Puzzle("00ed6d0c92fbd2e3d164be5870f33a3f")]
    public int Part2(string input) => Part2And3(input, 100);

    [Puzzle("c2eff10d6d075e935bd2a23732fe7ef2")]
    public int Part3(string input) => Part2And3(input, 100_000);
