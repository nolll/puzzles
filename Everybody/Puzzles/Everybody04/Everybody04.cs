...
public class Everybody04(string[] inputs) : EverybodyPuzzle
{
    protected override PuzzleResult RunPart1()
    {
        var result = RunPart1And2(inputs[0]);
    ...
    {
        var result = RunPart1And2(inputs[1]);
    ...
    public static int RunPart3(string input)
    {
        var list = input.Split(LineBreaks.Single).Select(int.Parse).ToList();
