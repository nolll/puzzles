...
public class FlipFlop202506 : FlipFlopPuzzle
{
    ...
    public int Part1(string input) => Parse(input)
        .Select(o => Move(o, Time))
        .Where(IsInFrame)
        .Count();
    ...
    private static IEnumerable<Coord> Parse(string input) => input.Split(LineBreaks.Single)
