namespace Tests.Codyssi.Puzzles.Codyssi2025.Codyssi202509;
...
public class Codyssi202509Tests
{
    ...
    [Fact]
    public void Part1() => Sut.Part1(Input).Should().Be(2870);

    [Fact]
    public void Part2() => Sut.Part2(Input).Should().Be(2542);

    [Fact]
    public void Part3() => Sut.Part3(Input).Should().Be(2511);

    private static Pzl.Codyssi.Puzzles.Codyssi2025.Codyssi202509.Codyssi202509 Sut => new();
}