namespace Tests.Codyssi.Puzzles.Codyssi2025.Codyssi202514;
...
public class Codyssi202514Tests
{
    ...
    [Fact]
    public void Part1() => Sut.Part1(Input).Should().Be(90);

    [Fact]
    public void Part2() => Sut.Part2(Input).Should().Be(8256);
