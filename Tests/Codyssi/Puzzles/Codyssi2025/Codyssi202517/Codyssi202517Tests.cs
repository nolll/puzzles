...
namespace Tests.Codyssi.Puzzles.Codyssi2025.Codyssi202517;
...
public class Codyssi202517Tests
{
    ...
    [Fact]
    public void Part1_1() => Sut.Part1(Input1).Should().Be(new BigInteger(6));
    
    [Fact]
    public void Part1_2() => Sut.Part1(Input2).Should().Be(new BigInteger(13));

    [Fact]
    public void Part2_1() => Sut.Part2(Input1).Should().Be(new BigInteger(17));
    
    [Fact]
    public void Part2_2() => Sut.Part2(Input2).Should().Be(new BigInteger(102));

    [Fact]
    public void Part3_1() => Sut.Part3(Input1).Should().Be("S1_0-S2_2-S2_3-S1_5-S1_6");
    
    [Fact]
    public void Part3_2() => Sut.Part3(Input2).Should().Be("S1_0-S1_2-S2_3-S3_4-S3_5-S1_6");
