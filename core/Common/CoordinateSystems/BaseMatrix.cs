...
public abstract class BaseMatrix<T> : BaseMatrix2
{
    protected readonly T _defaultValue;

    public abstract int Width { get; }
    public abstract int Height { get; }
    public MatrixDirection Direction { get; protected set; } // todo: should not be protected
    public MatrixAddress Address { get; protected set; } // todo: should not be protected
    public MatrixAddress StartAddress { get; protected set; } // todo: should not be protected
    ...
    public BaseMatrix(T defaultValue)
    {
    ...
    {
        var newMatrix = Create(Height, Width, _defaultValue);
        var oy = 0;
